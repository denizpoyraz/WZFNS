...
NVar 2
detajj                        detajj                        detajj                        detajj                                                          'F'    [0.000217854976654,8.3869562149]
ptl1                          ptl1                          ptl1                          ptl1                                                            'F'    [27.8285808563,1877.46411133]
NSpec 1
npu                           npu                           npu                           F                                                               'F'    [95,193]
...
class ReadFisher : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      const char* inputVars[] = { "detajj", "ptl1" };
...
{
   fFisher0 = -0.240923614003;
   fFisherCoefficients.push_back( 0.108918620058 );
   fFisherCoefficients.push_back( -0.000322334655594 );
